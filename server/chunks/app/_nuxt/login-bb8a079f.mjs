  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "flex flex-col w-full gap-3 h-full justify-center items-center",
        style: { "height": "400px" }
      }, _attrs))}><div class="flex gap-2 flex-col items-start justify-center">`);
      ...
      _push(`<h1 class="text-2xl font-bold"> Login </h1><form class="flex flex-col gap-2"><input${ssrRenderAttr("value", unref(formData).email)} type="email" placeholder="Email" class="input"><input${ssrRenderAttr("value", unref(formData).password)} type="password" placeholder="Password" class="input"><button type="submit" class="bg-green-900 mt-2 text-white rounded-lg py-2 px-4"> Login </button></form>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/register",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` I don&#39;t have an account `);
          } else {
            return [
              createTextVNode(" I don't have an account ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=login-bb8a079f.mjs.map
