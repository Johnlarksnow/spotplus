import { hasInjectionContext, getCurrentInstance, toRef, isRef, inject, version, defineAsyncComponent, ref, defineComponent, h, Suspense, nextTick, Transition, useSSRContext, watchEffect, watch, provide, shallowReactive, mergeProps, withCtx, createVNode, createApp, reactive, effectScope, isReactive, toRaw, unref, getCurrentScope, onScopeDispose, computed, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, shallowRef, isReadonly, toRefs, markRaw, isShallow, useSlots, resolveComponent, onUpdated, onUnmounted } from 'vue';
...
const _routes = [
  {
    name: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) ?? "checkout-id",
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/checkout/:id()",
    meta: __nuxt_page_meta$3 || {},
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./_nuxt/_id_-2e219eda.mjs').then((m) => m.default || m)
  },
  {
    ...
    children: [
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/index-08726d4f.mjs').then((m) => m.default || m)
      },
      {
        name: "dashboard-index-payments",
        path: "payments",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/payments-e4b95ebc.mjs').then((m) => m.default || m)
      },
      {
        name: "dashboard-index-renewals",
        path: "renewals",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/renewals-6b0d51fb.mjs').then((m) => m.default || m)
      },
      {
        name: "dashboard-index-upgrades",
        path: "upgrades",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/upgrades-ff2e5d5c.mjs').then((m) => m.default || m)
      }
    ],
    ...
    component: () => import('./_nuxt/index-55ee38bd.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-41a74489.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/login-bb8a079f.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/register-daa11887.mjs').then((m) => m.default || m)
  },
  {
    name: "upgrade",
    path: "/upgrade",
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth-284b8626.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-0c592af8.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-0d7f74ef.mjs').then((r) => r.default));
...
const layouts = {
  checkout: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/checkout-f85cbf6f.mjs').then((m) => m.default || m)),
  dash: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/dash-71bf6f23.mjs').then((m) => m.default || m)),
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-3bea14e7.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "bg-green-100 dark:text-white text-gray-900 font-inter min-h-screen dark:bg-[#050505]" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_NuxtLoadingIndicator, null, null, _parent));
      _push(ssrRenderComponent(_component_NuxtLayout, { class: "h-full" }, {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-9141243a.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-6a4bc869.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-879fc33e.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { __nuxt_component_1 as _, useRoute as a, useRouter as b, createError as c, useState as d, entry$1 as default, useNuxtApp as e, useRequestFetch as f, defineStore as g, defineAppConfig as h, defuFn as i, defineNuxtRouteMiddleware as j, useWindowScroll as k, navigateTo as n, onKeyStroke as o, useHead as u };
